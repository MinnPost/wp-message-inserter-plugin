...
?>
<a href="#" class="sm-close-btn" aria-label="<?php echo __( 'Close', 'wp-message-inserter-plugin' ); ?>"<?php echo $close_button_style; ?>><i class="far fa-times-circle" aria-hidden="true"></i></i></a>
